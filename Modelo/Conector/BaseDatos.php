<?php
    class BaseDatos extends PDO {
        ...
        public function __construct () {
            ...
            /**
             * Este fragmento de código invoca al constructor de PDO para establecer la conexión
             * Utiliza try catch para determinar si la conexión fue exitosa
             */
            try {
        ...
        // Función que recibe la consulta sql y ejecuta la operación correspondiente
        ...
        /**
         * Devuelve la cantidad de filas afectadas por la ejecucion SQL. Si el valor es < 0 no se pudo realizar la operción
         * @return integer  
         */
